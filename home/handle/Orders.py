        ...
        if ret:
            for l in ret:
                order = {
                    ...
                    "title":l["hi_title"],
                    "img_url":AVATAR_URL + l["hi_index_image_url"] if l["hi_index_image_url"] else "",
